...
session_start();
 if(isset($_POST['submit']) and !empty($_POST['nome_produto'])){
    include_once('config.php');
     ...
     $result = mysqli_query($conexao,"INSERT INTO produtos(nomeProduto,descricaoProduto,imagemProduto,dono,telefone,categoria,preco) VALUES ('$nomeProduto','$descricao','$image_produto','$dono',$telefone,$categoria,0
...
<body>
    <header>
        ...
        <div class="profile_area">
            ...
            if(!isset($_SESSION['email']) == true){
                ...
                echo "
                <span>Olá ".$_SESSION['username']."</span>
                <button>Sair</button>";
            }?>
    ...
    <main>
        <h2>Doar produto</h2>
        <form class="product_form" action='doacao.php' method='POST'>
            <div class="field">
